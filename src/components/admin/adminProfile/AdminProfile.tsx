        ...
        <div className='relative md:gap-10 h-screen flex flex-col-reverse md:flex-row md:justify-between text-white '>
            ...
            <div className='flex-[11_11_0%]'>
                <div className="h-screen flex flex-col justify-center items-center pt-20 md:pt-0">
                    ...
                    <h1 className="font-semibold text-4xl md:text-3xl text-adminblueColor mt-5">Satish Bhurtel</h1>
                    
                    <p className="text-gray-400 text-xl md:text-sm mt-2">Keensect Restaurant</p>

                    <div className="flex justify-between md:text-[12px] mt-4 text-gray-500 items-center gap-1">
                        <FaLocationDot />
                        <p>Hetauda-6, Chaugadha</p>
                    </div>

                    <div className="md:text-[12px] text-gray-500 mt-1">9867287169</div>
