  ...
  return (
    <div className='min-h-[50vh] flex md:flex-row flex-col items-center justify-center gap-10 py-10 px-10'>
        ...
        <div className='w-[400px] flex flex-col'>
            <h1 className='text-6xl font-bold uppercase mb-5 text-center md:text-start tracking-tighter'>Peer Restaurant</h1>
            ...
            <div className='flex flex-col items-center md:items-start'>
                <h2 className='text-2xl md:text-xl  font-bold md:font-semibold'>Address</h2>
                <p className='text-sm font-medium mb-2'>Hetauda-6</p>
                <h2 className='text-2xl md:text-xl font-bold md:font-semibold'>Phone no</h2>
