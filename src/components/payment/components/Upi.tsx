...
const Upi = () => {
  return (
    <div className='bg-secondaryColor rounded-2xl p-5 mx-5 md:mx-60'>
            <div className='flex justify-between px-5 mt-5'>
                <button><h3 className='text-white text-[14px]'>Blue Way</h3></button>
                <FaCircle  size={15} className='text-blue-800'/>
            </div>
            <div className='flex justify-between px-5 mt-5'>
                <button><h3 className='text-white text-[14px]'>Phone Pay</h3></button>
