...
const MorePayment = () => {
  return (
    <div className='bg-secondaryColor rounded-2xl p-5 mx-5 mb-5 md:mx-60'>
            <div className='flex justify-between items-center px-5 mt-5'>
                <div className='flex items-center gap-5'>
                    <FaWallet className='text-white'/>
                    <button><h3 className='text-white text-[14px]'>Esewa</h3></button>
                </div>
            ...
            <div className='flex justify-between items-center px-5 mt-5'>
                <div className='flex items-center gap-5'>
                    ...
                    <button><h3 className='text-white text-[14px]'>Cash on Delivery</h3></button>
                </div>
