    ...
    return (  
        ...
        <div className='bg-primaryColor'>
            ...
            <div className='flex-[11_11_0%]'>
                ...
                <p className="text-black font-semibold text-xl md:text-sm mt-2">{formData.name == ''? 'Your Restaurant Name' : formData.restaurant}</p>
                ...
                <div className="md:text-[12px] text-black font-semibold mt-1">{formData.name == ''? 'Your phone no' : formData.number}</div>
