        ...
        <div className='bg-primaryColor'>
            ...
            <div className='flex-[11_11_0%]'>
                ...
                <div className="flex flex-col md:flex-row px-5 py-5 gap-5 mt-5">
                    <button onClick={() => {setEditProfile(true)}} className="transition-all hover:scale-[1.05]  bg-transparent hover:bg-adminblueColor text-[12px] border-[1px] border-adminblueColor py-2 px-5 text-white">Edit Profile</button>
                    <Link href={'/login'}>
